...
int function GetTrans(Actor ActorRef)
	if IsPlayerVampireLord(ActorRef)
		return -1
	endIf
...
bool function IsPlayerVampireLord(Actor ActorRef)
	if ActorRef != PlayerRef
		return false
	endIf

	ActorBase BaseRef = ActorRef.GetLeveledActorBase()
	return BaseRef && MiscUtil.GetRaceEditorID(BaseRef.GetRace()) == "DLC1VampireBeastRace"
endFunction
