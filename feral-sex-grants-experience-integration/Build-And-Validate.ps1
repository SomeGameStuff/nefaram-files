...
foreach ($script in $scripts) {
    ...
    foreach ($required in @('Feral.Qualified', 'GetActiveFamily', 'AddActivityMastery')) {
...
Write-Output 'Feral Sex Grants Experience integration validated: upstream 1.8.0 pinned, morph-gated XP, matching-family mastery, and 2 compiled overrides.'
